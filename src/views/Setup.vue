                ...
                <v-card class="elevation-12">
                    ...
                    <v-stepper v-model="currentStep" vertical class="background: transparent">
                        ...
                        <v-stepper-content step="4">
                            ...
                            <v-btn to="/" color="primary" class="pa-0 ma-0">{{$t('actions.finish')}}</v-btn>
                        </v-stepper-content>
                    </v-stepper>
                </v-card>
            </v-flex>
...
<script lang="ts">
    ...
    export default class Setup extends Vue {
        ...
        @Action(INITIALIZE_LOCALE.actionName,
            {namespace: INITIALIZE_LOCALE.namespace}) initialiseLocale: any;
